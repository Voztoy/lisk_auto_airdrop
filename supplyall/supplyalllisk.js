...
const BALANCE_CONTRACT_ADDRESS = "0xac485391EB2d7D88253a7F1eF18C37f4242D1A24";

// Địa chỉ hợp đồng thực hiện giao dịch
const MINT_CONTRACT_ADDRESS = "0x5d4FE9b1Dc67d20ac79E5e8386D46517aA6b657c";
...
async function sendTransaction() {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        try {
            ...
            const C = ethers.utils.parseUnits(roundedB.toString(), 18);
